...
侧边栏「使用 LLM 结果缓存」：同题同模型同 prompt 版本可跳过 API。全流程 Stage 2 完成后运行 Stage 3。详见 [docs/LLM_CACHE.md](docs/LLM_CACHE.md)。
...
| [docs/LLM_CACHE.md](docs/LLM_CACHE.md) | 缓存键、降本与串行说明 |
